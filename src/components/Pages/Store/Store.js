    ...
    <div className='scrollmenu'>
      ...
      <div id='mundodiv' className='ws grid grid-rows-4 gap-8'>
        <div class="h-56 grid grid-cols-6 gap-20 content-center ...">
            ...
            <div></div>
            <div id='pilarw2' class="pilarw">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',</div>
            <div></div>
            <div></div>
          </div>
          <div class="h-56 grid grid-cols-6 gap-20 content-center ...">
            ...
            <div></div>
            <div id='pilarw4' class="pilarw">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',</div>
            <div></div>
            <div></div>
          </div>
          <div class="h-56 grid grid-cols-6 gap-20 content-center ...">
            ...
            <div></div>
            <div id='pilarw6' class="pilarw">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',</div>
            <div></div>
            <div></div>
          </div>
      </div>
